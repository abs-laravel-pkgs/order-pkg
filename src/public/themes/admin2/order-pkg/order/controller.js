    ...
    controller: function($http, $location, HelperService, $scope, $routeParams, $rootScope, $location) {
        ...
        var dataTable = $('#orders_list').DataTable({
            ...
            stateLoadCallback: function(settings) {
                ...
                if (state_save_val) {
                    $('#search_order').val(state_save_val.search.search);
                }
            ...
            scrollCollapse: true,
            ajax: {
                url: url(laravel_routes['getOrderList']),
                type: "GET",
                dataType: "json",
                data: function(d) {
            ...
            columns: [
                ...
                { data: 'mobile_no', name: 'orders.mobile_no' },
...
app.component('orderForm', {
    ...
    controller: function($http, $location, HelperService, $scope, $routeParams, $rootScope) {
        get_form_data_url = typeof($routeParams.id) == 'undefined' ? order_get_form_data_url : order_get_form_data_url + '/' + $routeParams.id;
        var self = this;
        self.hasPermission = HelperService.hasPermission;
        ...
        $scope.onSelectedCountry = function(id) {
            order_get_state_by_country = vendor_get_state_by_country;
            $http.post(
                order_get_state_by_country, { 'country_id': id }
            ).then(function(response) {
                // console.log(response);
        ...
        $scope.onSelectedState = function(id) {
            order_get_city_by_state = vendor_get_city_by_state
            $http.post(
                order_get_city_by_state, { 'state_id': id }
            ).then(function(response) {
                // console.log(response);
